...
facesDetecdatas = classificadorFace.detectMultiScale(imagemCinza)

for (x, y, l, a) in facesDetecdatas:
    imagem = cv2.rectangle(imagem, (x, y), (x + l, y + a), (0, 0, 255), 2)
    regiao = imagem[y:y + a, x:x + l]
    # y:y significa que começa no y e termina no y, mesma coisa para o x:x.
    # A variável região possui somente a região da face.
